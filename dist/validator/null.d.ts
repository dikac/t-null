...
export default class Null<MessageT> implements Validator<unknown, null, Readonly<Instance<unknown, MessageT>>>, Message<Function<[Readonly<Value & Validatable>], MessageT>> {
