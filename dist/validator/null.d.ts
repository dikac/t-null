...
export default class Null<MessageT> implements Validator<unknown, null, Readonly<Instance<unknown, MessageT>>>, Message<(result: Readonly<Value & Validatable>) => MessageT> {
